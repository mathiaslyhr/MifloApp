...
| **Main / Primary** | `#6260f6` | The single brand color. Solid & glass accents, bloom on hover, badges, focus ring. Its background expression is the purple (Lilac / Periwinkle) zone of the mesh. Exposed as `--color-primary` (with `--color-accent` kept as an alias). |
