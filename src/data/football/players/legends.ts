...
export const LEGENDS: readonly Footballer[] = [
  ...
  },
  {
    ...
    nationality: ['Germany'],
    positions: ['DF'],
    clubs: [{clubId: 'bayern', from: 1964, to: 1977}],
    honours: [
      {type: 'champions-league', count: 3},
  ...
  },
  {
    ...
    honours: [{type: 'ballon-dor', count: 1, years: [2003]}],
    tags: ['legends'],
  },
  {
    id: 'michael-owen',
    ...
    honours: [{type: 'ballon-dor', count: 1, years: [2001]}],
    tags: ['legends'],
  },
  {
    id: 'george-weah',
    ...
    honours: [{type: 'ballon-dor', count: 1, years: [1995]}],
    tags: ['legends'],
  },
  {
    id: 'paolo-maldini',
    ...
    positions: ['DF'],
    shirtNumbers: [3],
    clubs: [{clubId: 'ac-milan', from: 1985, to: 2009}],
    honours: [{type: 'champions-league', count: 5}],
    tags: ['legends'],
  },
  {
    id: 'gianluigi-buffon',
    ...
    honours: [{type: 'world-cup', count: 1, years: [2006]}],
    tags: ['legends'],
  },
  {
    ...
    positions: ['FW'],
    shirtNumbers: [10],
    clubs: [{clubId: 'juventus', from: 1993, to: 2012}],
    honours: [
  ...
  },
  {
    ...
    positions: ['FW', 'MF'],
    shirtNumbers: [10],
    clubs: [{clubId: 'roma', from: 1993, to: 2017}],
    honours: [{type: 'world-cup', count: 1, years: [2006]}],
    tags: ['legends'],
  },
  {
  ...
  },
  {
    ...
    honours: [{type: 'world-cup', count: 1, years: [1994]}],
    tags: ['legends'],
  },
  {
  ...
  },
  {
    ...
    nationality: ['Germany'],
    positions: ['DF'],
    clubs: [{clubId: 'bayern', from: 2002, to: 2017}],
    honours: [
      {type: 'champions-league', count: 1, years: [2013]},
      {type: 'world-cup', count: 1, years: [2014]},
    ],
