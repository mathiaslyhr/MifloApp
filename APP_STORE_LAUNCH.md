...
Plan: **ship the MVP now** (M0–M4 are complete), defer M5. The app code is
production-ready; what's left below is mostly App Store Connect / account work,
not code. Bundle id: `com.mathiaslyhr.miflo` · version 1.0 / build 1.
...
- [ ] **4. Screenshots** — capture 6.7" and 6.5" iPhone sets from the simulator
      (Home, Lobby, Question, Podium). Add an iPad set only if you support iPad.
...
- [ ] **M5** — persist `game_results` + profile / score-history.
